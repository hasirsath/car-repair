                    ...
                    <div class="row gy-4">
                        <div class="col-md-4">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                ...
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i>blisscarspa@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 class="text-uppercase"> sms</h5>
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i>+91 9316458646</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <h4 class="text-light mb-4">Quick Links</h4>
                    ...
                    <a class="btn btn-link" href="service.php">Book Service</a>
                </div>
